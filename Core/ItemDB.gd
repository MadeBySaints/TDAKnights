...
var consumable = [
	...
	{id = 1000, name = "HP Potion", hpOnUse = 50, mpOnUse = 0, weight = 1, timer = 0, baseVal = 100, img = "res://Sprites/Consumables/HP Potion.png"},
	{id = 3004, name = "MP Potion", hpOnUse = 0, mpOnUse = 50, weight = 1, timer = 0, baseVal = 100, img = "res://Sprites/Consumables/MP Potion.png"},
	{id = 3005, name = "HP Flask", hpOnUse = 100, mpOnUse = 0, weight = 1, timer = 0, baseVal = 200, img = "res://Sprites/Consumables/HP Flask.png"},
	{id = 3006, name = "MP Flask", hpOnUse = 0, mpOnUse = 100, weight = 1, timer = 0, baseVal = 200, img = "res://Sprites/Consumables/MP Flask.png"}
]
